...
import { UserProfile, JournalEntry, WeeklySummaryData } from "../types";
...
export async function generateWeeklySummary(payload: WeeklySummaryPayload): Promise<WeeklySummaryData> {
    ...
    try {
        ...
        return await response.json() as WeeklySummaryData;
    } catch (error) {
