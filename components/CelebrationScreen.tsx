...
const CelebrationScreen: React.FC<CelebrationScreenProps> = ({ completionSummary, onRestart, onExport }) => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-[#fdfbf7] to-emerald-50 dark:from-gray-900 dark:to-emerald-900/50 p-6 text-center overflow-hidden">
      ...
      <div className="animate-fade-in" style={{ animationFillMode: 'forwards', animationDelay: '0.3s', opacity: 0 }}>
        ...
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-lg rounded-2xl p-6 max-w-2xl text-left space-y-4 overflow-y-auto max-h-[60vh] border border-white dark:border-gray-700">
          <h2 className="text-2xl font-light text-emerald-800 dark:text-emerald-200">Your 90-Day Evolution</h2>
          <p className="text-gray-700 dark:text-gray-300 whitespace-pre-line font-light leading-relaxed">{summaryContent}</p>
        </div>
