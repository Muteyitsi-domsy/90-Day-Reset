        ...
        <div className="relative w-full max-w-4xl max-h-[90vh] mx-4 bg-[var(--card-bg)] rounded-2xl shadow-2xl overflow-hidden animate-scale-in" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="policy-section">
            ...
            <ul>
              ...
              <li><strong>Apple App Store:</strong> Payment processing for in-app subscriptions and purchases. Your payment card details are handled by Apple and are never accessible to us.</li>
          ...
          <div className="policy-section">
            ...
            <p>When you make a purchase through the Apple App Store, the following data flows occur:</p>
            <ul>
              <li><strong>What Apple handles:</strong> Your payment method, billing address, and transaction details. We never see or store these.</li>
              <li><strong>What RevenueCat receives:</strong> Anonymous or identified user ID, subscription status, product purchased, and device platform. Used solely to verify your access entitlement within the app.</li>
